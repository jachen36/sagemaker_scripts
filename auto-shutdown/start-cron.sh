...
# Sample cron command
# Check for idle status every hour and save log file at present working directory
echo "@hourly /home/ec2-user/anaconda3/envs/JupyterSystemEnv/bin/python3.6 $PWD/autostop.py --idle-time $IDLE_TIME --log-dir $LOG_DIR" | crontab -
